...
public interface IFile {
    ...
    public static final char delim = File.separatorChar;
    public static final int maxFileNameLen = 64;

    public static final int READ = 0x01;
    public static final int WRITE = 0x02;
    public static final int APPEND = 0x04;
    public static final int CREATE = 0x08;
