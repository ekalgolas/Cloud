...
public class MetadataManager {
	 ...
	 *            {@link Directory} object to be written
	 */
	public static void storenfsMetadata(final HashMap<String, File> fileMap) {
		final File metadataStore = new File(AppConfig.getValue("server.nfs.metadataFile"));
		try (ObjectOutputStream outputStream = new ObjectOutputStream(new FileOutputStream(metadataStore))) {
