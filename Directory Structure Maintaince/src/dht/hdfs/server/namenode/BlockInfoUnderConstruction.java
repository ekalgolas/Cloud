...
import dht.hdfs.server.common.HdfsServerConstants.ReplicaState;
...
public class BlockInfoUnderConstruction extends BlockInfo {
	...
	static class ReplicaUnderConstruction extends Block {
		private DatanodeID expectedLocation;
		 ...
		 */
		DatanodeID getExpectedLocation() {
	...
	public void setExpectedLocations(DatanodeID[] targets) {
	 ...
	 * chooseTargets()).
	 */
	public DatanodeID[] getExpectedLocations() {
		int numLocations = replicas == null ? 0 : replicas.size();
		DatanodeID[] locations = new DatanodeID[numLocations];
		for (int i = 0; i < numLocations; i++)
	...
	public void initializeBlockRecovery(long recoveryId) {
		...
		for (int i = 0; i < replicas.size(); i++) {
			...
			primaryNodeIndex = i;
			// mostRecentLastUpdate = primary.getExpectedLocation()
			// .getLastUpdate();
			// }
		}
		if (primary != null) {
	...
	void addReplicaIfNotPresent(DatanodeID dn, Block block, ReplicaState rState) {
