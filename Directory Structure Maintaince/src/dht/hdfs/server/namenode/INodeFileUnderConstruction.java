...
public class INodeFileUnderConstruction extends INodeFile {
	...
	/**
	 * Converts an INodeFileUnderConstruction to an INodeFile. The original
	 * modification time is used as the access time. The new modification is the
	 * specified mtime.
	 */
	...
	// @Override
	// public INodeFileUnderConstruction recordModification(final Snapshot
	// latest,
	...
	/**
	 * Convert the last block of the file to an under-construction block. Set
	 * its locations.
	 */
	// @Override
