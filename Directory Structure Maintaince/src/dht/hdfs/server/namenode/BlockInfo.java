...
public class BlockInfo extends Block {
	 ...
	 * and triplets[3*i+1] and triplets[3*i+2] are references to the previous
	 * and the next blocks, respectively, in the list of blocks belonging to
	 * this data-node.
	 * 
	...
	// private void setDatanode(int index, DatanodeDescriptor node, BlockInfo
	// previous,
	// BlockInfo next) {
	// assert this.triplets != null : "BlockInfo is not initialized";
	// int i = index * 3;
	 ...
	 * specified DatanodeDescriptor. If the head is null then form a new list.
	 * 
	 ...
	 * DatanodeDescriptor. If this block is the head of the list then return the
	 * next block as the new head.
	 * 
	 * @return the new head of the list or null if the list becomes empty after
	 *         deletion.
	 */
