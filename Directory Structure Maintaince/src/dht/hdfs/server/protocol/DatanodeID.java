...
package dht.hdfs.server.protocol;
...
public class DatanodeID implements Comparable<DatanodeID> {
	...
	public DatanodeID(DatanodeID from) {
		this(from.getIpAddr(), from.getHostName(), from.getStorageID(), from.getXferPort(), from.getInfoPort(),
	 ...
	 *            ipc server port
	 */
	public DatanodeID(String ipAddr, String hostName, String storageID, int xferPort, int infoPort, int infoSecurePort,
			int ipcPort) {
		this.ipAddr = ipAddr;
