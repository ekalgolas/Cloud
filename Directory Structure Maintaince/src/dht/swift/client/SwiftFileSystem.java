...
public class SwiftFileSystem implements IFileSystem {
	...
	public IDFSFile create(DhtPath path) throws IOException {
		return SwiftFile.create(path, master, location);
	}
	...
	public void rename(DhtPath srcPath, DhtPath dstPath) throws IOException {
		...
		SwiftFile.delete(srcPath, table);
	}
