 ...
 * <p/>
 * This is demo for how to periodically get system load info. Network static is
 * acquired using technique in SimpleRawLogger. You can move code in main to
 * your dedicate thread.
 * <p/>
...
public class SystemInfo {
	...
	public static void main(final String args[]) throws InterruptedException, IOException {
		...
		for (;;) {
			...
			// because jvm takes time to calculate used cpu time over total cpu
			// time to get ratio.
